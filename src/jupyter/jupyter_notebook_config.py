...
c.NotebookApp.tornado_settings = {
  "headers": {
    "Content-Security-Policy": "frame-ancestors 'self' http://dev.deepnote.org:* beta.deepnote.org hotel.test beta.deepnote.com deepnote-staging.com deepnote-staging.org deepnote.org deepnote.com"
  }
}
...
#c.Session.username = 'andrejchudy'
